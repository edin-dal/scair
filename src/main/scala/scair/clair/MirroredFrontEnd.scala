...
/**
  ...
  *
  * @return Input to OperationDef, either: 
  *    OperandDef, ResultDef, RegionDef, SuccessorDef, OpPropertyDef, OpAttributeDef
  */
inline def getOpInput[Elem]: String => OpInput = {
  inline erasedValue[Elem] match
    case _: Operand[t]   => 
      (name: String) => OperandDef(
        id = name,
        indent[t],
        Single
      )
    ...
    case _: Region    => 
      (name: String) => RegionDef(
        id = name,
        Single
      )
    case _: Successor => 
      (name: String) => SuccessorDef(
        id = name,
        Single
      )
    case _: Property[t]  =>
      (name: String) => OpPropertyDef(
        id = name,
        indent[t]
      )
    case _: Attribute[t] => 
      (name: String) => OpAttributeDef(
        id = name,
        indent[t]
      )
    case _ => 
...
/**
  ...
  * OperationDef.
  * 
  * @return Lambda that produces an input to OperationDef, given a string
  */
...
/**
  ...
  *
  * @param m - Mirror Product of an dialect enum case.
  * @return Lambda that produces an Operadtion Def given a dialect name.
  */
...
/**
  ...
  * @param dialect_name
  */
inline def summonDialectOps[Prods <: Tuple](dialect_name: String): ListType[OperationDef] = {
...
/**
  ...
  *
  * @param m - Sum Mirror of a given dialect
  */
