...
import scair.ir.{Attribute, DictType, ListType, Value}
...
object ConcreteExample {
  ...
  import test.newir.ValueConversions.{opToVal, valToOp, resToVal, valToRes}
