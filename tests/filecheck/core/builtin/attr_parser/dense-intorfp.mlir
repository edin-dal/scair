...
"test.op"() {hello = dense<[10, 11]> : tensor<2xf32>} : () -> ()
"test.op"() {hello = dense<11> : tensor<2xf32>} : () -> ()
"test.op"(%0) : (i32) -> ()
...
// CHECK:   "test.op"() {hello = dense<[10, 11]> : tensor<2xf32>} : () -> ()
// CHECK:   "test.op"() {hello = dense<11> : tensor<2xf32>} : () -> ()
// CHECK:   "test.op"(%0) : (i32) -> ()