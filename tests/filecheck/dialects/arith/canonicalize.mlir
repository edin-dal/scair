...
func.func @tripleAddAdd(%0: index) -> index {
  ...
  %4 = "arith.addi"(%2, %3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %4 : index
}
// CHECK-NEXT:    func.func @tripleAddAdd(%0: index) -> index {
// CHECK-NEXT:      %1 = "arith.constant"() <{value = 59 : index}> : () -> index
// CHECK-NEXT:      %2 = "arith.addi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
...
func.func @tripleAddSub0(%0: index) -> index {
  %1 = "arith.constant"() <{value = 17 : index}> : () -> index
  %2 = "arith.constant"() <{value = 42 : index}> : () -> index
  %3 = "arith.subi"(%1, %0) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  %4 = "arith.addi"(%2, %3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %4 : index
}
// CHECK-NEXT:    func.func @tripleAddSub0(%0: index) -> index {
// CHECK-NEXT:      %1 = "arith.constant"() <{value = 59 : index}> : () -> index
// CHECK-NEXT:      %2 = "arith.subi"(%1, %0) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
// CHECK-NEXT:      func.return %2 : index
// CHECK-NEXT:    }
...
func.func @tripleSubAdd0(%0: index) -> index {
  ...
  %2 = "arith.constant"() <{value = 42 : index}> : () -> index
  %3 = "arith.addi"(%1, %0) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  %4 = "arith.subi"(%2, %3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %4 : index
}
...
func.func @subSub0(%0: index, %1: index) -> index {
  %2 = "arith.subi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  %3 = "arith.subi"(%2, %0) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %3 : index
}
// CHECK-NEXT:    func.func @subSub0(%0: index, %1: index) -> index {
// CHECK-NEXT:      %2 = "arith.constant"() <{value = 0 : index}> : () -> index
// CHECK-NEXT:      %3 = "arith.subi"(%2, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
...
// CHECK-NEXT:      %1 = "arith.constant"() <{value = 59 : index}> : () -> index
// CHECK-NEXT:      %2 = "arith.subi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
// CHECK-NEXT:      func.return %2 : index
// CHECK-NEXT:    }

func.func @subAdd1(%0: index, %1: index) -> index {
  %2 = "arith.addi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  %3 = "arith.subi"(%2, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %3 : index
}
...
func.func @doubleAddSub2(%0: index, %1: index) -> index {
  %2 = "arith.subi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  %3 = "arith.addi"(%1, %2) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %3 : index
}
...
func.func @tripleMulIMulIIndex(%0: index) -> index {
  ...
  %4 = "arith.muli"(%3, %2) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %4 : index
}
// CHECK-NEXT:    func.func @tripleMulIMulIIndex(%0: index) -> index {
// CHECK-NEXT:      %1 = "arith.constant"() <{value = 15 : index}> : () -> index
// CHECK-NEXT:      %2 = "arith.muli"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
// CHECK-NEXT:      func.return %2 : index
// CHECK-NEXT:    }
...
func.func @tripleMulIMulII32(%0: i32) -> i32 {
  ...
  %3 = "arith.muli"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
...
// CHECK-NEXT:      %2 = "arith.muli"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
...
func.func @tripleMulLargeInt(%0: i256) -> i256 {
  ...
  %3 = "arith.addi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (i256, i256) -> i256
  %4 = "arith.addi"(%3, %2) <{overflowFlags = #arith.overflow<none>}> : (i256, i256) -> i256
  func.return %4 : i256
}
...
// CHECK-NEXT:      %2 = "arith.addi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (i256, i256) -> i256
...
// CHECK-NEXT:      %2 = "arith.subi"(%0, %1) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
// CHECK-NEXT:      func.return %2 : i32
// CHECK-NEXT:    }
...
func.func @addiMuliToSubiRhsIndex(%0: index, %1: index) -> index {
  ...
  %4 = "arith.addi"(%0, %3) <{overflowFlags = #arith.overflow<none>}> : (index, index) -> index
  func.return %4 : index
}
...
//   %3 = "arith.muli"(%1, %2) <{overflowFlags = #arith.overflow<none>}> : (vector<3xi64>, vector<3xi64>) -> vector<3xi64>
//   %4 = "arith.addi"(%0, %3) <{overflowFlags = #arith.overflow<none>}> : (vector<3xi64>, vector<3xi64>) -> vector<3xi64>
...
func.func @addiMuliToSubiLhsI32(%0: i32, %1: i32) -> i32 {
  %2 = "arith.constant"() <{value = -1 : i32}> : () -> i32
  %3 = "arith.muli"(%1, %2) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
  %4 = "arith.addi"(%3, %0) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
  func.return %4 : i32
}
...
//   %2 = "arith.constant"() <{value = dense<-1> : vector<3xi64>}> : () -> vector<3xi64>
//   %3 = "arith.muli"(%1, %2) <{overflowFlags = #arith.overflow<none>}> : (vector<3xi64>, vector<3xi64>) -> vector<3xi64>
//   %4 = "arith.addi"(%3, %0) <{overflowFlags = #arith.overflow<none>}> : (vector<3xi64>, vector<3xi64>) -> vector<3xi64>
//   func.return %4 : vector<3xi64>
// }
