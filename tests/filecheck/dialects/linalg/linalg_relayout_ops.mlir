...
// matching `static_inner_tiles` entry is the dynamic marker, -1 upstream
// (ShapedType::kDynamic).
%dyn, %ddst = "test.op"() : () -> (index, tensor<16x8x8x?xf32>)
%packed_dyn = "linalg.pack"(%src, %ddst, %dyn) <{
  inner_dims_pos = array<i64: 0, 1>,
  static_inner_tiles = array<i64: 8, -1>,
  operandSegmentSizes = array<i32: 1, 1, 0, 1>
}> : (tensor<128x256xf32>, tensor<16x8x8x?xf32>, index) -> tensor<16x8x8x?xf32>
...
%unpacked_dyn = "linalg.unpack"(%ddst, %src, %dyn) <{
  inner_dims_pos = array<i64: 0, 1>,
  static_inner_tiles = array<i64: 8, -1>
}> : (tensor<16x8x8x?xf32>, tensor<128x256xf32>, index) -> tensor<128x256xf32>
...
// CHECK-NEXT:   %9, %10 = "test.op"() : () -> (index, tensor<16x8x8x?xf32>)
// CHECK-NEXT:   %11 = "linalg.pack"(%0, %10, %9) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, -1>}> : (tensor<128x256xf32>, tensor<16x8x8x?xf32>, index) -> tensor<16x8x8x?xf32>
...
// CHECK-NEXT:   %14 = "linalg.unpack"(%10, %0, %9) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, -1>}> : (tensor<16x8x8x?xf32>, tensor<128x256xf32>, index) -> tensor<128x256xf32>
// CHECK-NEXT: }
