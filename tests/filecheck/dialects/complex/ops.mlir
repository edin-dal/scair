...
builtin.module {
  func.func @ops(%arg0: f32) {
    ...
    %4 = "complex.im"(%2): (complex<f32>) -> f32
    %5 = "complex.abs"(%2): (complex<f32>) -> f32
    %6 = "complex.add"(%2, %2): (complex<f32>, complex<f32>) -> complex<f32>
    // %7 = "complex.cos"(%2) : (complex<f32>) -> complex<f32>
    %8 = "complex.div"(%2, %2) : (complex<f32>, complex<f32>) -> complex<f32>
    // %9 = "complex.eq"(%2, %2) : (complex<f32>, complex<f32>) -> i1
    // %10 = "complex.exp"(%2) : (complex<f32>) -> complex<f32>
    // %11 = "complex.expm1"(%2) : (complex<f32>) -> complex<f32>
    // %12 = "complex.log"(%2) : (complex<f32>) -> complex<f32>
    // %13 = "complex.log1p"(%2) : (complex<f32>) -> complex<f32>
    %14 = "complex.mul"(%2, %2) : (complex<f32>, complex<f32>) -> complex<f32>
    %15 = "complex.neg"(%2) : (complex<f32>) -> complex<f32>
    // %16 = "complex.neq"(%2, %2) : (complex<f32>, complex<f32>) -> i1
    // %17 = "complex.sign"(%2) : (complex<f32>) -> complex<f32>
    // %18 = "complex.sin"(%2) : (complex<f32>) -> complex<f32>
    %19 = "complex.sub"(%2, %2) : (complex<f32>, complex<f32>) -> complex<f32>
    // %20 = "complex.tanh"(%2) : (complex<f32>) -> complex<f32>
    // %21 = "complex.pow"(%2, %2) : (complex<f32>, complex<f32>) -> complex<f32>
    // %22 = "complex.sqrt"(%2) : (complex<f32>) -> complex<f32>
    // %23 = "complex.rsqrt"(%2) : (complex<f32>) -> complex<f32>
    // %24 = "complex.atan2"(%2, %2) : (complex<f32>, complex<f32>) -> complex<f32>
    // %25 = "complex.tan"(%2) : (complex<f32>) -> complex<f32>
