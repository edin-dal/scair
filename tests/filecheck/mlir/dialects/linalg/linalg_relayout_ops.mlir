...
// CHECK-NEXT:   %2 = "linalg.pack"(%0, %1) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, 32>, operandSegmentSizes = array<i32: 1, 1, 0, 0>}> : (tensor<128x256xf32>, tensor<16x8x8x32xf32>) -> tensor<16x8x8x32xf32>
// CHECK-NEXT:   %3 = "test.op"() : () -> tensor<8x16x8x32xf32>
// CHECK-NEXT:   %4 = "linalg.pack"(%0, %3) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, 32>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, outer_dims_perm = array<i64: 1, 0>}> : (tensor<128x256xf32>, tensor<8x16x8x32xf32>) -> tensor<8x16x8x32xf32>
// CHECK-NEXT:   %5, %6, %7 = "test.op"() : () -> (f32, tensor<125x255xf32>, tensor<16x8x8x32xf32>)
// CHECK-NEXT:   %8 = "linalg.pack"(%6, %7, %5) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, 32>, operandSegmentSizes = array<i32: 1, 1, 1, 0>}> : (tensor<125x255xf32>, tensor<16x8x8x32xf32>, f32) -> tensor<16x8x8x32xf32>
// CHECK-NEXT:   %9, %10 = "test.op"() : () -> (index, tensor<16x?x8x?xf32>)
// CHECK-NEXT:   %11 = "linalg.pack"(%0, %10, %9) <{inner_dims_pos = array<i64: 0, 1>, static_inner_tiles = array<i64: 8, -9223372036854775808>, operandSegmentSizes = array<i32: 1, 1, 0, 1>}> : (tensor<128x256xf32>, tensor<16x?x8x?xf32>, index) -> tensor<16x?x8x?xf32>
