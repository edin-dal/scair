...
%m0 = "memref.alloc"() <{"operandSegmentSizes" = array<i32: 0, 0>}> : () -> memref<f32>
%m1 = "memref.alloc"() <{"operandSegmentSizes" = array<i32: 0, 0>}> : () -> memref<1xf32>
%m2 = "memref.alloc"(%0) <{"operandSegmentSizes" = array<i32: 1, 0>}> : (index) -> memref<?xf32>
%m3 = "memref.alloc"(%1) <{"operandSegmentSizes" = array<i32: 1, 0>}> : (index) -> memref<3x?x5xf32>
%m4 = "memref.alloc"(%0, %1) <{"operandSegmentSizes" = array<i32: 2, 0>}> : (index, index) -> memref<?x5x?xf32>
...
%4 = "memref.load"(%m2, %0) : (memref<?xf32>, index) -> f32
"memref.store"(%4, %m2, %1) : (f32, memref<?xf32>, index) -> ()
...
// CHECK-NEXT:    %2 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<f32>
// CHECK-NEXT:    %3 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<1xf32>
// CHECK-NEXT:    %4 = "memref.alloc"(%0) <{operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?xf32>
// CHECK-NEXT:    %5 = "memref.alloc"(%1) <{operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<3x?x5xf32>
// CHECK-NEXT:    %6 = "memref.alloc"(%0, %1) <{operandSegmentSizes = array<i32: 2, 0>}> : (index, index) -> memref<?x5x?xf32>
...
// CHECK-NEXT:    %9 = "memref.load"(%4, %0) : (memref<?xf32>, index) -> f32
// CHECK-NEXT:    "memref.store"(%9, %4, %1) : (f32, memref<?xf32>, index) -> ()
